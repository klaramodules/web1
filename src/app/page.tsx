...
export default function Home() {
  ...
  // Enhetlig knappstil
  const buttonStyle = {
    backgroundColor: "rgba(47, 62, 47, 0.6)", // mörkgrön med 60% transparens
    color: beige,
  ...
  return (
    <section className="relative text-center overflow-hidden min-h-screen w-full">
      ...
      <div className="relative z-10 mt-32 px-4">
        ...
        <p className="max-w-xl mx-auto mb-4 text-lg leading-relaxed text-gray-100">
          Each home is built by experienced Finnish housebuilders, completed in the
          factory, and transported by truck to your site — where it’s lifted into
          place and connected to power and water.
        </p>
        <p className="max-w-xl mx-auto mb-8 text-lg leading-relaxed text-gray-100">
          ...
          sustainable materials, and homes built to last — ready for modern living.
        </p>
